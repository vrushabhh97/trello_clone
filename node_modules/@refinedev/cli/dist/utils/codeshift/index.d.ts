import { ASTPath, Collection, ImportDeclaration, JSCodeshift, JSXAttribute, JSXElement, JSXExpressionContainer } from "jscodeshift";
...
export declare const addOrUpdateImports: (j: JSCodeshift, source: Collection, importPath: string, importIdentifierNames: string[], insertFunc?: ((sourceDeclaration: Collection<ImportDeclaration>, targetDeclaration: ImportDeclaration) => void) | undefined, isDefault?: boolean) => void;
